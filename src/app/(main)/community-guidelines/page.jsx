      ...
      <div className="my-10 rounded-2xl bg-white p-6 text-gray-900 sm:p-10">
        ...
        <ul className="ml-4 list-inside list-disc space-y-2">
          ...
          <li>
            ...
            about what others eat or how they track
          </li>
          <li>
            Engage constructively in comments and avoid unnecessary negativity
          </li>
        </ul>
        ...
        <ul className="ml-4 list-inside list-disc space-y-2">
          ...
          <li>
            Anti-LGBTQ+ slurs or content that demeans someone based on sexual
        ...
        <ul className="ml-4 list-inside list-disc space-y-2">
          ...
          <li>
            Content that glorifies unhealthy relationships with food or body
            image
          </li>
          <li>
        ...
        <ul className="ml-4 list-inside list-disc space-y-2">
          ...
          <li>
            Keep meal names, descriptions, and comments appropriate for all
            audiences
          </li>
          <li>
            Ensure your profile name and username do not contain slurs, hate
            speech, or inappropriate language
          </li>
          <li>
            Do not use profile photos or meal images to display prohibited
            content
          </li>
        </ul>
        ...
        <ul className="ml-4 list-inside list-disc space-y-2">
          ...
          <li>
            <strong>Warning:</strong> Users may receive a warning for first-time
            or minor violations
          </li>
          <li>
            <strong>Temporary Suspension:</strong> Repeated violations may
            result in temporary suspension of social features
          </li>
          <li>
