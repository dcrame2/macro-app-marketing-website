  ...
  return (
    <Container>
      <div className="my-10 rounded-2xl bg-white p-6 text-gray-900 sm:p-10">
        ...
        <h3 className="mb-2 mt-4 text-lg font-semibold">Non-Personal Data:</h3>
        <ul className="ml-4 list-inside list-disc space-y-2">
        ...
        <h2 className="mb-4 mt-6 text-2xl font-semibold">3. Use of Information</h2>
        ...
        <h2 className="mb-4 mt-6 text-2xl font-semibold">4. Data Sharing</h2>
        <p className="mb-4">
        ...
        <h2 className="mb-4 mt-6 text-2xl font-semibold">5. Data Protection</h2>
        <p className="mb-4">
        ...
        <h2 className="mb-4 mt-6 text-2xl font-semibold">6. Children's Privacy</h2>
        <p className="mb-4">
        ...
        <h2 className="mb-4 mt-6 text-2xl font-semibold">8. Contact Information</h2>
        <p className="mb-2">
