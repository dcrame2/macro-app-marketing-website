...
const TYPE_CONFIG = {
  meal: {
    label: 'meal',
    heading: 'View this meal on InstaCal',
    ogTitle: 'Check out this meal on InstaCal',
  },
  workout: {
    label: 'workout',
    heading: 'View this workout on InstaCal',
    ogTitle: 'Check out this workout on InstaCal',
  },
  user: {
    label: 'profile',
...
export function DeepLinkLanding({ type, id }) {
  ...
  const deepLink = `instacal://${type}/${id}`
